...
<br><br>
     ...
     <div class="container">         
           ...
           <div class="col-sm-6 form-group">
            ...
            <div class="col-sm-6 form-group">
                <label for="name-lic">လိုင်စင်အမှတ်</label>
                <input type="text" class="form-control" name="lic" id="lic" required>
            </div>
            ...
            <div class="col-sm-6 form-group">
                <label for="nrc">မှတ်ပုံတင်အမှတ်</label>
                <input type="text" class="form-control" name="nrc" id="nrc" required>
            </div>
            ...
            <div class="col-sm-6 form-group">
                <label for="blood">သွေးအမျိုးအမည်</label>
              <select name="blood" id="blood" class="form-control">
                <option value="ab">အေဘီ</option>
                <option value="a">အေ</option>
                <option value="b">ဘီ</option>
                <option value="o">အို</option>
              </select>
            </div>
            <div class="col-sm-6 form-group">
            ...
            <div class="col-sm-6 form-group">
                <label for="vdate">TOWN</label>
                <input type="text" name="dob" class="form-control" id="vdate">
            </div>
            ...
            <div class="col-sm-6 form-group">
              ...
              <select name="type" id="type" class="form-control">
                ...
                <option value="in_in">In_in</option>
                <option value="over">In_over</option>
              </select>
            </div>
            <div class="col-sm-6 form-group">
             ...
             <div class="col-sm-6 form-group">
                ...
                <input type="text" name="dob" class="form-control" id="vou">
            </div>
            <div class="col-sm-6 form-group">
            ...
            <div class="col-sm-12 form-group">
                <label for="de">Change_Date</label>
                <input type="date" name="de" class="form-control" id="de">
            </div>            
            <div class="col-sm-12">
